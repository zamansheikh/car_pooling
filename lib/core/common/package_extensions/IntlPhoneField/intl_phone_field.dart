...
import 'dart:async';
import 'package:car_pooling/core/common/package_extensions/IntlPhoneField/country_picker_dialog.dart';
import 'package:car_pooling/core/common/package_extensions/IntlPhoneField/helpers.dart';
      ...
      validator: (value) {
        ...
        if (!widget.disableLengthCheck) {
          return value.length >= _selectedCountry.minLength && value.length <= _selectedCountry.maxLength
              ? null
              : "Phone number must be ${_selectedCountry.minLength} digits long.";
        }
